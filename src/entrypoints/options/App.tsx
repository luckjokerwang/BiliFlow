            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                <ToggleSwitch
                  ...
                  onChange={(val) =>
                    saveSettings({ ...settings, autoSummarize: val }, `已${val ? '开启' : '关闭'}自动提炼总结`)
                  }
                ...
                <SliderInput
                  ...
                  onChange={(val) =>
                    saveSettings({ ...settings, minDurationForAutoSec: val }, `最小触发时长已设为 ${val} 秒`)
                  }
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                <ToggleSwitch
                  ...
                  onChange={(val) =>
                    saveSettings({ ...settings, showTimelineMarkers: val }, `已${val ? '开启' : '关闭'}进度条高能打点`)
                  }
                ...
                <ToggleSwitch
                  ...
                  onChange={(val) =>
                    saveSettings({ ...settings, showHoverCard: val }, `已${val ? '开启' : '关闭'}悬浮要点卡片`)
                  }
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                <ToggleSwitch
                  ...
                  onChange={(val) =>
                    saveSettings({ ...settings, enableNumberKeySeek: val }, `已${val ? '开启' : '关闭'}数字键快速跳转`)
                  }
                ...
                <ToggleSwitch
                  ...
                  onChange={(val) =>
                    saveSettings({ ...settings, autoFullscreenHud: val }, `已${val ? '开启' : '关闭'}全屏自动挂载`)
                  }
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                <ToggleSwitch
                  ...
                  onChange={(val) =>
                    saveSettings({ ...settings, showToasts: val }, `已${val ? '开启' : '关闭'}操作 Toast 提示`)
                  }
                ...
                <ToggleSwitch
                  ...
                  onChange={(val) =>
                    saveSettings({ ...settings, defaultHudOpen: val }, `已${val ? '开启' : '关闭'}进入视频默认展开`)
                  }
